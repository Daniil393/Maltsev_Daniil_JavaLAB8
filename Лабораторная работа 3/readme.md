...
*Конструктор*:
  + public AutomaticGun3(int ammo, int rateOfFire):
    * принимает начальное количество патронов.
    * принимает скорострельность.
    * вызывает конструктор базового класса super(ammo).
    * проверяет, что скорострельность положительная.
...
Заряжаем 5 патронов...
Лишних патронов: 0
Текущее состояние: Пистолет [патроны: 5]
...
Бах!
Клац!
После стрельбы: Пистолет [патроны: 0]

Разряжаем пистолет...
Извлечено патронов: 0
После разрядки: Пистолет [патроны: 0]

--- AutomaticGun3 ---
Создан автомат:
Автомат [патроны: 10, скорострельность: 3]

Стреляем одной очередью:
Бах!
Бах!
Бах!
После очереди: Автомат [патроны: 7, скорострельность: 3]
...
Бах!
Бах!
После стрельбы: Автомат [патроны: 1, скорострельность: 3]
```
